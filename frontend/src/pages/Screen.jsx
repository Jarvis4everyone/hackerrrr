    ...
    <div className="space-y-6">
      <div className="bg-hack-dark border border-hack-green/20 rounded-lg p-6">
        <div className="flex items-center gap-3 mb-6">
          <Monitor className="text-hack-green" size={24} />
          <h2 className="text-xl font-mono text-hack-green">Screen Share</h2>
        </div>
        ...
        <div className="flex gap-4 mb-6">
          ...
          <button
            ...
            disabled={!isStreaming}
            className="flex items-center gap-2 px-4 py-2 bg-hack-gray hover:bg-hack-gray/80 border border-hack-green/30 text-white rounded-lg transition-all font-mono disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <Maximize2 size={18} />
            Fullscreen
          </button>
      ...
      >
        <h3 className="text-lg font-mono text-hack-green mb-4">Screen Feed</h3>
        <div className="bg-black rounded-lg overflow-hidden aspect-video flex items-center justify-center">
          {isStreaming ? (
            ...
            <div className="text-gray-500 font-mono text-center">
              {selectedPC ? 'Click "Start Stream" to view screen share' : 'Select a PC to start streaming'}
            </div>
          )}
        </div>
      </div>
